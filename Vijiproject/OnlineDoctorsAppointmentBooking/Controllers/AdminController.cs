...
namespace OnlineBookingDoctorsAppointment.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult AddDoctor()
        {
            ...
            ViewBag.IsAvailable = Availability();
            return View(doctor);
        }
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        [NonAction]
        public IEnumerable<SelectListItem> Availability()
        {
            var available = new List<SelectListItem>
            {
                new SelectListItem{Text="--Availability--",Value="0",Disabled=true,Selected=true},
